...
import { Home, Map, Sparkles, Bed, Route, Wallet, ListChecks } from 'lucide-vue-next'
...
const items = [
  ...
  { to: '/places', label: 'Planes', icon: Sparkles },
...
<template>
  ...
  >
    <ul class="mx-auto max-w-5xl grid grid-cols-7">
      <li v-for="item in items" :key="item.to">
        <RouterLink
          :to="item.to"
          class="tap flex flex-col items-center justify-center gap-0.5 py-2 text-[10px]"
